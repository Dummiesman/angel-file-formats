...
{
    char[4]         header = "CAI1";
    unsigned short  nShortcuts;                     // Number of shortcut roads
    Shortcut        shortcuts[nShortcuts];          // Shortcuts
};
```
...
    ShortcutRoadData    right;       // Data for right side
    ShortcutRoadData    left;        // Data for left side
...
    ShortcutRoadEnd        end;     // End of the road
    ShortcutRoadEnd        start;   // Start of the road
`};
```
